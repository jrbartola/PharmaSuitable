	...
	constructor(props) {
		...
		this.state = {
		  tabs: [
		      ...
		      {pill: "Tramadol", description: "Treats moderate to severe pain", color: "orange", count: 7},
		      {pill: "Adderall", description: "Used to treat attention deficit hyperactivity disorder", color: "green", count: 24}
		  ],
		  selected: {pill: "Tylenol", description: "This is a decription for Tylenol", color: "red", count: 2},
		  modules: [
